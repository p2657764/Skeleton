...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 27px; top: 299px; position: absolute; " width="53px"> </asp:Label>
        ...
        <br />
        <br />
        <asp:Button ID="btnOK" runat="server" style="z-index: 1; left: 16px; top: 249px; position: absolute" Text="OK" OnClick="btnOK_Click_Click" />
        <br />
        <asp:Button ID="FindButton" runat="server" OnClick="Button1_Click" style="z-index: 1; left: 337px; top: 11px; position: absolute" Text="Find" />
        <br />
