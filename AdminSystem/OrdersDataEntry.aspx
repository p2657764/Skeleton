...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 130px; top: 248px; position: absolute; " Text="Cancel" height="26px" OnClick="btnCancel_Click" width="60px" />
        ...
        <br />
        <br />
        <asp:Button ID="btnFind" runat="server" OnClick="btnFind_Click" style="z-index: 1; left: 339px; top: 11px; position: absolute" Text="Find" height="26px" width="61px" />
        <br />
        ...
        <asp:Button ID="btnOrderList" runat="server" height="26px" OnClick="btnOrderList_Click" style="z-index: 1; left: 220px; top: 248px; position: absolute; width: 114px" Text="View Order List" />
    </form>
</body>
</html>
